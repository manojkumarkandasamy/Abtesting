...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ABTesting.Android.dll" comes first in this list. */
		"ABTesting.Android.dll",
		"ABTesting.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		...
		"Xamarin.GooglePlayServices.TagManager.Api.dll",
		"Xamarin.GooglePlayServices.TagManager.dll",
